...
$parcel$export(
  module.exports,
  "IndicTransliterate",
  () => $3f93eb6d5bf69cb7$export$a62758b764e9e41d
);
$parcel$export(
  module.exports,
  "TriggerKeys",
  () => $9090cd5fdacb9284$export$24b0ea3375909d37
);
$parcel$export(
  module.exports,
  "getTransliterateSuggestions",
  () => $ad7f01abe8daa1b6$export$27f30d10c00bcc6c
);
$parcel$export(
  module.exports,
  "getTransliterationLanguages",
  () => $bb5a013037ca2153$export$58f2e270169de9d3
);
...
$parcel$export(
  $479169a4406ef977$exports,
  "ReactTransliterate",
  () => $479169a4406ef977$export$b7fa6c785ac95e64,
  (v) => ($479169a4406ef977$export$b7fa6c785ac95e64 = v)
);
$parcel$export(
  $479169a4406ef977$exports,
  "Active",
  () => $479169a4406ef977$export$c3c7cbf43a3f0561,
  (v) => ($479169a4406ef977$export$c3c7cbf43a3f0561 = v)
);
...
const $ad7f01abe8daa1b6$export$27f30d10c00bcc6c = async (word, config) => {
  ...
  try {
    const res = await fetch(
      $905ee54827307cc1$export$ca6dda5263526f75 +
        `tl/${lang}/${
          word === "." || word === ".."
            ? " " + word.replace(".", "%2E")
...
const $3f93eb6d5bf69cb7$export$a62758b764e9e41d = ({
  renderComponent: renderComponent = (props) =>
    /*#__PURE__*/ $dWhh5$reactjsxruntime.jsx("input", {
      ...props,
    }),
  lang: lang = "hi",
  offsetX: offsetX = 0,
  ...
  const shouldRenderSuggestions = $dWhh5$react.useMemo(
    () =>
  ...
  const handleChange = (e) => {
    ...
    if (currentWord && enabled) {
      ...
      const left = Math.min(
        caretPos.left,
        rect.width - $3f93eb6d5bf69cb7$var$OPTION_LIST_MIN_WIDTH / 2
      );
      // minimum of the caret position from the top of the input
      // and the height of the input
      const top = Math.min(
        caretPos.top + $3f93eb6d5bf69cb7$var$OPTION_LIST_Y_OFFSET,
        rect.height
      );
      setTop(top);
      setLeft(left);
  ...
  return /*#__PURE__*/ $dWhh5$reactjsxruntime.jsxs("div", {
    ...
    children: [
      ...
      shouldRenderSuggestions &&
        options.length > 0 &&
        /*#__PURE__*/ $dWhh5$reactjsxruntime.jsx("ul", {
          style: {
          ...
          children: Array.from(new Set(options)).map((item, index) =>
            /*#__PURE__*/ $dWhh5$reactjsxruntime.jsx(
              "li",
              {
                className:
                  index === selection
