      ...
      <Modal isOpen={isOpen} size="8xl" onClose={onClose}>
        ...
        <ModalContent>
          ...
          <ModalBody>
            ...
            <iframe
              src={`${process.env.NEXT_PUBLIC_GRAFANA_URL}/d/Zj4zOgA7y/dhruva-general-requests-dashboard?orgId=2&var-apiKeyName=${apiKeyName}&var-userId=${selectedUser}&var-inferenceServiceId=${service_id}&from=now-1h&to=now&kiosk=tv`}
              width={"100%"}
              height={600}
            />
          </ModalBody>
